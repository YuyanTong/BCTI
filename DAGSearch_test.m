function [Gmin_adjMatrix,scores,evals,dags] = DAGSearch_test(X,maxIter,restartVal,complexityFactor,CPD,clamped,PP,verbose,dag)
% Inputs:
%   X(instance,feature)
...
parents = find(adjMatrix(:,i));%找到潜在父亲节点
